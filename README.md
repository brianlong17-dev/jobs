...
> **Note:** `main.py` points to test data in data/raw testData.jsonl by default. It can take the file path of the raw text generated by the scrapr as an optional parameter.
